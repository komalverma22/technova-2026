      ...
      <div className="w-full flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-start">
        ...
        <div className="w-full lg:w-1/2 text-white flex flex-col justify-center">
          <div className="space-y-4 text-base md:text-lg leading-relaxed text-gray-200">
            <p>
              TECHNOVA is the Annual Technical Symposium of DCRUST and is one of the largest of its kind in Haryana. Technova has grown by leaps and bounds over the years. It is held over 2 day in the month of March and has consistently attracted participants from all over NCR. Technova is all about technical creativity and innovation. Innovation in students is always cherished and supported. In its previous editions. Technova brought participation pool of over 2500 students from the colleges under DCRUST.
            </p><p>
              Many technical and entrepreneurship events are held during the fest including Robotics, Coding marathons, quizzes events. These are broadly classified into various Departmental Events. Apart from this, Workshops and exhibitions are also held. To high- light the social responsibility of Engineers, social/environmental awareness initiatives are undertaken under the banner of various departments. Project Expo and Poster presentation events are also organised in order to encourage the practical knowledge and Hobby Expo is another major attraction.
            </p>
          </div>
        </div>
      </div>
