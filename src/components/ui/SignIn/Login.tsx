...
export default function LoginPage() {
  return (
    <div className="bg-slate-950 flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
      <div className="flex w-full max-w-sm flex-col gap-4">
        <div className="self-start">
          <BackButton fallbackPath="/" />
        </div>
        <a href="/" className="flex items-center gap-2 self-center font-medium text-white">
          <div className="bg-indigo-600 text-white flex size-6 items-center justify-center rounded-md">
